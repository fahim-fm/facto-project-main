...
import Button from "~/components/atoms/getbtn"; // ✅ Import the reusable button
    ...
    <section className="pt-[60px] pb-[10px] lg:pt-[121px] lg:pb-[10px]">
      <div className="container container-pad">
        <div className="w-full flex flex-col justify-center">
          ...
          <h1
            className="text-center mt-[28px] lg:mt-[30px] 2xl:mt-[32px] mx-auto max-w-[1042px] max-h-[165px] text-gray-900 font-bold
          ...
          <p
            className="text-center mx-auto mt-3 sm:mt-4 xl:mt-6 max-w-[1042px] text-[#686868] font-manrope font-normal 
          ...
          <div className="mt-8 sm:mt-9 lg:mt-12 flex justify-center sm cursor-pointer">
            <Button
              label="Get Started"
              variant="primary"
              size="md"
